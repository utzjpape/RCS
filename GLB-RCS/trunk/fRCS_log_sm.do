...
*				quiet: forvalues imod = 1/`M' {
	...
	*				mi impute chained (regress) xfcons1_pc xfcons2_pc xfcons3_pc xfcons4_pc xnfcons1_pc xnfcons2_pc xnfcons3_pc xnfcons4_pc = xfcons0_pc xnfcons0_pc xdurables_pc hhsize pchild psenior i.hhsex i.hhwater hhcook_5 i.hhtoilet i.hhmaterial i.hhmode i.hhplot i.hhfood i.cluster i.hhmod, add(`nI') noimp report
			...
			**MI method selection used: Chained regressions
			mi impute chained (logit, augment) dxfcons1_pc dxfcons2_pc dxfcons3_pc dxfcons4_pc dxnfcons1_pc dxnfcons2_pc dxnfcons3_pc dxnfcons4_pc = pxfcons0_pc pxnfcons0_pc pxdurables_pc `model', add(`nI') report noisily augment force
			...
			**MI method selection used: Chained regressions
			mi impute chained (regress) dxfcons1_pc dxfcons2_pc dxfcons3_pc dxfcons4_pc dxnfcons1_pc dxnfcons2_pc dxnfcons3_pc dxnfcons4_pc = pxfcons0_pc pxnfcons0_pc pxdurables_pc `model', add(`nI') report noisily augment
			**Obtain one predicted dy in the following lines:	
			...
			*Make dummy for Y>0:
			...
			clonevar odxfcons`imod'_pc=dxfcons`imod'_pc // keep original for dummy
			clonevar odxnfcons`imod'_pc=dxnfcons`imod'_pc // keep original for dummy
			replace lnxfcons`imod'_pc=-2.30259 if dxfcons`imod'_pc==0
			replace lnxnfcons`imod'_pc=-2.30259 if dxnfcons`imod'_pc==0
									}

					*set MI
					mi set wide
					mi register imputed lnxfcons1_pc lnxnfcons1_pc lnxfcons2_pc lnxnfcons2_pc lnxfcons3_pc lnxnfcons3_pc lnxfcons4_pc lnxnfcons4_pc dxfcons1_pc dxnfcons1_pc dxfcons2_pc dxnfcons2_pc dxfcons3_pc dxnfcons3_pc dxfcons4_pc dxnfcons4_pc
					mi register regular oxfcons0_pc oxnfcons0_pc oxfcons1_pc oxnfcons1_pc oxfcons2_pc oxnfcons2_pc oxfcons3_pc oxnfcons3_pc oxfcons4_pc oxnfcons4_pc
					...
					*Chained regressions to estimate the joint
					mi impute chained (regress, noisily) dxfcons1_pc  (regress, conditional(if dxfcons1_pc>=.5)  noisily) lnxfcons1_pc ///
									  (regress, noisily) dxnfcons1_pc (regress, conditional(if dxnfcons1_pc>=.5) noisily) lnxnfcons1_pc /// 
									  (regress, noisily) dxfcons2_pc  (regress, conditional(if dxfcons2_pc>=.5)  noisily) lnxfcons2_pc ///
									  (regress, noisily) dxnfcons2_pc (regress, conditional(if dxnfcons2_pc>=.5) noisily) lnxnfcons2_pc /// 
									  (regress, noisily) dxfcons3_pc  (regress, conditional(if dxfcons3_pc>=.5)  noisily) lnxfcons3_pc ///
									  (regress, noisily) dxnfcons3_pc (regress, conditional(if dxnfcons3_pc>=.5) noisily) lnxnfcons3_pc /// 
									  (regress, noisily) dxfcons4_pc  (regress, conditional(if dxfcons4_pc>=.5)  noisily) lnxfcons4_pc ///
									  (regress, noisily) dxnfcons4_pc (regress, conditional(if dxnfcons4_pc>=.5) noisily) lnxnfcons4_pc /// 
					...
					*Make l and u vars for intreg:
					forvalues imod = 1/4 {					
					gen uxfcons`imod'_pc=lnxfcons`imod'_pc
					gen uxnfcons`imod'_pc=lnxnfcons`imod'_pc					
					gen lxfcons`imod'_pc=lnxfcons`imod'_pc
					gen lxnfcons`imod'_pc=lnxnfcons`imod'_pc
					replace lxfcons`imod'_pc=. if xfcons`imod'_pc==0 // missing for l* when zero: left-censored
					replace lxnfcons`imod'_pc=. if xnfcons`imod'_pc==0 // missing for l* when zero: left-censored
									}
					
					*set MI
					mi set wide
					mi register passive lnxfcons1_pc lnxnfcons1_pc lnxfcons2_pc lnxnfcons2_pc lnxfcons3_pc lnxnfcons3_pc lnxfcons4_pc lnxnfcons4_pc			
					mi register regular oxfcons0_pc oxnfcons0_pc oxfcons1_pc oxnfcons1_pc oxfcons2_pc oxnfcons2_pc oxfcons3_pc oxnfcons3_pc oxfcons4_pc oxnfcons4_pc
					mi register regular hh* cluster lnxfcons0_pc lnxnfcons0_pc pchild psenior cfcons_pc cnfcons_pc xdurables_pc lnxdurables_pc
					mi register passive xcons_pc xfcons_pc xfcons1_pc xnfcons1_pc xfcons2_pc xnfcons2_pc xfcons3_pc xnfcons3_pc xfcons4_pc xnfcons4_pc
					...
					*Fill in:
					forvalues imod = 1/4 {					
					`mipre' replace lnxfcons`imod'_pc=newxfcons`imod'_pc 
					`mipre' replace lnxnfcons`imod'_pc=newxnfcons`imod'_pc
									}
				...
				*set MI
				...
				forvalues imod = 1/`M' {
					*food
					mi impute reg lnxfcons`imod'_pc i.pxfcons0_pc i.pxnfcons0_pc i.pxdurables_pc `model'           [aweight=weight] ,  noisily replace
					*non-food
					mi impute reg lnxnfcons`imod'_pc i.pxfcons0_pc i.pxnfcons0_pc i.pxdurables_pc `model'           [aweight=weight] ,  noisily replace
					}
			...
			*Single MI Tobit
				...
				*Make l and u vars for intreg (Use ln instead of x*):
					forvalues imod = 1/4 {					
					gen uxfcons`imod'_pc=lnxfcons`imod'_pc 
					gen uxnfcons`imod'_pc=lnxnfcons`imod'_pc  					
					gen lxfcons`imod'_pc=lnxfcons`imod'_pc 
			...
			*Single MI two part models
					...
					*set MI
					...
					forvalues imod = 1/`M' {
					*Food					
					mi impute chained (logit, augment noisily) dxfcons`imod'_pc (regress, conditional(if dxfcons`imod'_pc>=.5) noisily) lnxfcons`imod'_pc ///
							=i.pxfcons0_pc i.pxnfcons0_pc i.pxdurables_pc `model', report replace
							
					*Non-food					
					mi impute chained (logit, augment noisily) dxnfcons`imod'_pc (regress, conditional(if dxnfcons`imod'_pc>=.5) noisily) lnxnfcons`imod'_pc ///
							=i.pxfcons0_pc i.pxnfcons0_pc i.pxdurables_pc `model', report replace
...
*			quiet: forvalue i=1/`M'{
			...
			dis "check pt"
				...
				*Anti-log transformation: rounding is to avoid extremely small number close to zero after transformation. The 2nd step imputaion is used only when predicted y ==1. 
				forvalue i=1/4{
					mi passive: replace xfcons`i'_pc=round(exp(lnxfcons`i'_pc), 0.0001) if dxfcons`i'_pc>=0.5
					mi passive: replace xnfcons`i'_pc=round(exp(lnxnfcons`i'_pc), 0.0001) if dxnfcons`i'_pc>=0.5
					mi passive: replace xfcons`i'_pc= 0  if dxfcons`i'_pc<0.5
					mi passive: replace xnfcons`i'_pc=0  if dxnfcons`i'_pc<0.5
					  		}
											}

						
			else if ("`smethod'"=="TwostMITobit" | "`smethod'"=="MIreg" | "`smethod'"=="MItobit" | "`smethod'"=="MItwopart" ) {
				*Anti-log transformation: rounding is to avoid extremely small number close to zero after transformation. The 2nd step imputaion is used only when predicted y ==1. 
				forvalue i=1/4{
					mi passive: replace xfcons`i'_pc=round(exp(lnxfcons`i'_pc), 0.0001) 
					mi passive: replace xnfcons`i'_pc=round(exp(lnxnfcons`i'_pc), 0.0001)
					  		}
											}
...
program define RCS_collate
	syntax using/, dirbase(string) nsim(integer) nmi(integer) lmethod(namelist) povline(string) deflator(string)
	*prepare output directories
	local lc_sdTemp = "`dirbase'/Temp"
	local lc_sdOut = "`dirbase'/Out"
	local N = `nsim'
...
program define RCS_analyze
	syntax using/, dirbase(string) lmethod(namelist)  povline(string) deflator(string)
	*prepare output directories
	local lc_sdTemp = "`dirbase'/Temp"
	local lc_sdOut = "`dirbase'/Out"
