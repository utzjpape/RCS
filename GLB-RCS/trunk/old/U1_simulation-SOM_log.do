...
*local lmethod = "med avg"
*local lmethod = "reg tobit"
*local lmethod = "tobit"
*local lmethod = "med avg reg reg2 tobit tobit2 MICE MImvn"
*local lmethod = "med avg reg tobit MICE MImvn"
*local lmethod = "reg reg2 reg3 tobit tobit2 tobit3"
...
/* temporarily skip since these are already run. 
